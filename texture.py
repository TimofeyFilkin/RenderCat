...
class Texture:
    ...
    def __init__(self, app):
        ...
        self.textures['cat'] = self.get_texture(path='textures/Cat.jpg')
        self.textures['cactus'] = self.get_texture(path='textures/10436_Cactus_v1_Diffuse.jpg')
